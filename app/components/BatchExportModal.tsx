...
export default function BatchExportModal({
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const fileName = `내신기출_성적표_${period}_${new Date().toISOString().split('T')[0]}.zip`;
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl shadow-xl max-w-lg w-full mx-4 p-6">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold text-gray-900">일괄 이미지 내보내기</h2>
                    {!exporting && (
                        <button
                            onClick={onClose}
                        ...
                        <div className="mb-6">
                            <p className="text-gray-600 mb-2">
                                {schoolFilter ? (
                                    ...
                                    '전체'
                                )} 학생 <span className="font-bold">{filteredStudents.length}명</span>의 성적표를 이미지로 내보냅니다.
                            </p>
